    ...
    properties = {
      "user_data" = "${base64encode(<<EOF
          ...
          clish:
            ...
            - add user ansibleuser uid 0 homedir /home/ansibleuser
            - set user ansibleuser password-hash '${var.chkp_passwd_hash}'
            - add rba user ansibleuser roles adminRole
            - set user ansibleuser shell /bin/bash"
          runcmd:
